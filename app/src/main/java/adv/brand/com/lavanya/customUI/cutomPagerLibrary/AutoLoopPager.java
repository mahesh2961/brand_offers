...
public class AutoLoopPager extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LayoutParams pagerLp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        mViewPager.setLayoutParams(pagerLp);
        addView(mViewPager);

        mIndicator = new AnimCirclePagerIndicator(context);
        LayoutParams indicatorLp = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
